        ...
        <>
            {
                products.length === 0 ? <article className="d-flex justify-content-center">
                    ...
                    <Row className='m-5'>
                        {
                            products.map(product => product.origin === 'WashingMachine' &&
                                <Col lg={4}>
                                    <section
                                        style={{ height: "270px" }}
                                    ...
                                    >
                                        ...
                                        <article>
                                            ...
                                            <aside className="d-flex align-items-center ">
                                                ...
                                                <span onClick={() => handaleAddToWishdom(product)} className="wishdom-btn  p-2">
...
export default DrawerMachineRoute;